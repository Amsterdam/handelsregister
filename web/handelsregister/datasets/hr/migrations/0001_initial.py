# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-11-07 20:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sbi_code', models.CharField(db_index=True, help_text='De codering van de activiteit conform de SBI2008', max_length=6)),
                ...
                ('sbi_code_tree', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='sbicodes.SBICodeHierarchy')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vestigingsnummer', models.CharField(db_index=True, help_text='Betreft het identificerende gegeven voor de Vestiging', max_length=12, null=True)),
                ('kvk_nummer', models.CharField(db_index=True, help_text='Betreft het identificerende gegeven voor Maatschappelijke', max_length=8, null=True)),
                ('sbi_code', models.CharField(db_index=True, help_text='De codering van de activiteit conform de SBI2008', max_length=5, null=True)),
                ('activiteitsomschrijving', models.TextField(blank=True, help_text='\n            De omschrijving van de activiteiten die de\n            Vestiging of Rechtspersoon uitoefent', null=True)),
                ...
                ('sbi_tree', django.contrib.postgres.fields.jsonb.JSONField(null=True)),
                ('sbi_main_category', models.CharField(db_index=True, max_length=1, null=True)),
                ('sbi_sub_category', models.CharField(db_index=True, max_length=2, null=True)),
                ('sbi_sub_sub_category', models.CharField(db_index=True, max_length=3, null=True)),
                ('q1', models.TextField(db_index=True, null=True)),
                ('q2', models.TextField(db_index=True, null=True)),
                ('q3', models.TextField(db_index=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postbus_nummer', models.CharField(blank=True, db_index=True, max_length=10, null=True)),
                ...
                ('geometrie', django.contrib.gis.db.models.fields.PointField(blank=True, null=True, srid=28992)),
                ('straatnaam', models.CharField(blank=True, db_index=True, max_length=100, null=True)),
                ...
                ('huisnummer', models.DecimalField(blank=True, db_index=True, decimal_places=0, max_digits=5, null=True)),
                ('huisnummertoevoeging', models.CharField(blank=True, max_length=5, null=True)),
                ('postcode', models.CharField(blank=True, db_index=True, max_length=6, null=True)),
                ('plaats', models.CharField(blank=True, db_index=True, max_length=100, null=True)),
                ('correctie', models.NullBooleanField()),
                ('correctie_level', models.IntegerField(null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('query_string', models.CharField(blank=True, db_index=True, max_length=180, null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eigenaar_mks_id', models.DecimalField(blank=True, db_index=True, decimal_places=0, max_digits=18, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('huwelijksdatum', models.DateField(blank=True, max_length=8, null=True)),
                ('geboortedatum', models.DateField(blank=True, max_length=8, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.CharField(max_length=20, primary_key=True, serialize=False)),
                ('rsin', models.CharField(blank=True, db_index=True, max_length=9, null=True)),
                ('verkorte_naam', models.CharField(blank=True, max_length=60, null=True)),
                ('ook_genoemd', models.CharField(blank=True, max_length=600, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Onderneming',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.DecimalField(decimal_places=0, max_digits=18, primary_key=True, serialize=False)),
                ('rol', models.CharField(blank=True, choices=[('EIGENAAR', 'EIGENAAR'), ('AANSPRAKELIJKE', 'AANSPRAKELIJKE')], max_length=14, null=True)),
                ...
                ('status', models.CharField(blank=True, max_length=21, null=True)),
                ('duur', models.CharField(blank=True, max_length=240, null=True)),
                ('natuurlijkpersoon', models.OneToOneField(blank=True, help_text='niet null bij natuurlijkpersoon', null=True, on_delete=django.db.models.deletion.CASCADE, to='hr.NatuurlijkPersoon')),
                ('niet_natuurlijkpersoon', models.OneToOneField(blank=True, help_text='niet null bij niet-natuurlijkpersoon', null=True, on_delete=django.db.models.deletion.CASCADE, to='hr.NietNatuurlijkPersoon')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('communicatiegegevens', models.ManyToManyField(help_text='Afgeleid van communicatiegegevens van inschrijving', to='hr.Communicatiegegevens')),
                ('handelsnamen', models.ManyToManyField(to='hr.Handelsnaam')),
                ('maatschappelijke_activiteit', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='vestigingen', to='hr.MaatschappelijkeActiviteit')),
